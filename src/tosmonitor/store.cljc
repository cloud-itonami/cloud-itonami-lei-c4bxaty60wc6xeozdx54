(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (MetLife, Inc., LEI
  C4BXATY60WC6XEOZDX54) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "MetLife, Inc."
   :website    "https://www.metlife.com"})

(def ^:private demo-full-text
  "Terms and Conditions\nBy accessing or using this website you agree to be bound by these Terms and Conditions. The content of this site is provided by MetLife, Inc. for general informational purposes about insurance and financial products only and is subject to change without notice. These Terms are governed by the laws of the State of Delaware, without regard to conflict-of-law principles.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.metlife.com/about-us/terms-and-conditions/"
   :retrieved-at "2026-07-10T07:31:00Z"
