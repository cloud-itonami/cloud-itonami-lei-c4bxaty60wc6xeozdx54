...
MetLife, Inc., per ADR-2607110300 -- a read-only reference archive. As part
...
- **Company**: MetLife, Inc., LEI C4BXATY60WC6XEOZDX54, website
  `https://www.metlife.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.metlife.com/about-us/terms-and-conditions/`,
  retrieved-at `2026-07-10T07:31:00Z`, doc-type `:terms-of-service`.
...
company/domain shape (a US insurance holding company).
